...
def main():    
    ...
    # Avoiding Exploding Gradient Problem by set maximum size for the gradient's steps: 
    ...
    for item in predictions:
        ...
        tmp_array.append(item['predictions'][0])
    predictions = np.array(tmp_array)
...
def my_input_fn(features, targets, batch_size=1, shuffle=True, num_epochs=None, train_function=False):
    ...
    Args:
      ...
      train_function: True or False. Whether input function used in training part.
    Returns:
